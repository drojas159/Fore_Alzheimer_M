<%-- 
    Document   : CargarDatos02.jsp
    Created on : 4/01/2020, 12:09:59 AM
    Author     : Daniela
--%>
                ...
                <div class="container-fluid">
                    ...
                    <form   name="formulario" method="post" enctype="multipart/form-data" >
                        ...
                        <div class="d-none d-md-inline-block form-inline ml-auto mr-0 mr-md-3 my-2 my-md-0"     >
                            <button type="submit" class="btn btn-primary btn-block" onclick="cargarArchivo('ETCSV')">Cargar</button>
                        </div>
                    </form>
                    ...
                    <p>
                        ...
                        <a href="CargarDatos03.jsp" class="btn btn-primary btn-lg active" role="button">Siguiente</a>
                    </p>
